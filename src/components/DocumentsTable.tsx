...
export function DocumentsTable({
  ...
  async function copyEmail(id: string, email: string) {
    try {
      ...
      setCopiedEmailId(id);
      setTimeout(() => setCopiedEmailId((v) => (v === id ? null : v)), 1200);
    } catch {}
  }
              ...
              {loading ? (
                ...
                items.map((d) => (
                  <tr key={d.id} className="border-t">
                    <td className="px-3 py-2 font-medium text-gray-900 truncate max-w-[220px] align-middle">
                      {d.name}
                    </td>
                      ...
                      <div className="flex items-center gap-2">
                        <span className="font-mono select-all">
                          {revealed[d.id]
                            ? d.password
                            : "\u2022".repeat(
                                Math.min(d.password?.length || 8, 8)
                              )}
                        </span>
                        <Button
                          type="button"
                          ...
                          aria-label={
                            revealed[d.id] ? "Hide password" : "Show password"
                          }
                        >
                          {revealed[d.id] ? (
                    ...
                    <td className="px-3 py-2 text-gray-700 truncate max-w-[140px] align-middle">
                      {d.country}
                    </td>
                    <td className="px-3 py-2 text-gray-700 truncate max-w-[140px] align-middle">
                      {d.city}
                    ...
                    <td className="px-3 py-2 text-gray-700 truncate max-w-[160px] align-middle">
                      {d.phone}
                    </td>
